...
export declare class MealFoodUnitController {
    private readonly mealFoodUnitService;
    constructor(mealFoodUnitService: MealFoodUnitService);
    findOne(userId: string, ccalNorm: number, id: GetMealFoodUnitByIdDto['mealFoodUnitId']): Promise<{
        mealFoodUnit: {
            meal: {
                mealUnit: {
                    mealDay: {
